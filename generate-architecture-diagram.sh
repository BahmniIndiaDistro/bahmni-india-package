...
if
  docker run --rm -it --name bahpkg -v ${PWD}:/input pmsipilot/docker-compose-viz:latest  render -m image --force docker-compose.yml --output-file=docker-compose-architecture-diagram.png $1 $2 $3
then
